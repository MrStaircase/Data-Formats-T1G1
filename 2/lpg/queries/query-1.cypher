//return a compact profile for a given shop specified in $shop: capacity, logo, and 
//counts of customers/employees/products it’s involved with.

MATCH (s:LocalBusiness {legalName:$shop}) //make sure to define the parameter before running (e.g :params {shop:'shop2'})
